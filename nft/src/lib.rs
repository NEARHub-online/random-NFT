...
use near_sdk::{
    env, near_bindgen, AccountId, Balance, CryptoHash, PanicOnDefault, Promise, PromiseOrValue, ext_contract
};
...
const MAX_NFT_MINT: u16 = 2000;
const MINT_PRICE_1: u128 = 0;
const MINT_PRICE_2: u128 = 6_000_000_000_000_000_000_000_000;
const MINT_PRICE_3: u128 = 10_000_000_000_000_000_000_000_000;
const MINT_PRICE_4: u128 = 15_000_000_000_000_000_000_000_000;
const NFT_IMAGES: &str = "https://cloudflare-ipfs.com/ipfs/bafybeiahhhtnyqri24mq24a46bhlef2tnd2xvrukcgkkygizlbgxbkt3u4/photo_2022-11-14_19-49-30.jpg";
...
impl Contract {
    ...
    */
    #[init]
    pub fn new_default_meta(owner_id: AccountId, receiver_id: AccountId, receiver_id1: AccountId, receiver_id2: AccountId) -> Self {
        assert!(
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Animaze Animation Film festival 2022 Virtual Ticket".to_string(),
                symbol: "Animaze".to_string(),
    ...
    */
    #[init]
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata,  receiver_id: AccountId, receiver_id1: AccountId, receiver_id2: AccountId) -> Self {
        ...
        this.perpetual_royalties.insert(&receiver_id, &400);
        this.perpetual_royalties.insert(&receiver_id1, &300);
        this.perpetual_royalties.insert(&receiver_id2, &300);
        this
