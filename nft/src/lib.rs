...
const NFT_IMAGES: &str = "https://cloudflare-ipfs.com/ipfs/QmPa54TUMXo1j2JFsm8njkMh4133PQGrorfEUa7AWVDAFi/";
...
impl Contract {
    ...
    */
    ...
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata, receiver_id: AccountId) -> Self {
        ...
        this.perpetual_royalties.insert(&env::current_account_id(), &1000);
