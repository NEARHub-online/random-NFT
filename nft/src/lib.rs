...
const MAX_NFT_MINT: u16 = 10;
const MINT_PRICE: u128 = 5_000_000_000_000_000_000_000_000;
const NFT_IMAGES: &str = "https://cloudflare-ipfs.com/ipfs/bafybeih3u5xfjqzgoxc5mnj6qyg4qt2nnnxjhlw2nro4gxmy55iyeynk2i/Day%20of%20the%20Dead%203.jpg";
...
impl Contract {
    ...
    pub fn new_default_meta(owner_id: AccountId, receiver_id: AccountId) -> Self {
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Day of the Dead NEAR Hub Comics Exclusive".to_string(),
                symbol: "NHCOMIC".to_string(),
    ...
    */
    ...
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata, receiver_id: AccountId) -> Self {
        ...
        this.perpetual_royalties.insert(&receiver_id, &1000);
        this
