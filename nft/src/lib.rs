...
const MAX_NFT_MINT: u16 = 990;
const MAX_NFT_MINT_SPECIAL: u16 = 10;
const NFT_IMAGES: &str = "https://cloudflare-ipfs.com/ipfs/bafybeigk5n5govfki7nrxb7vtz5llvgxudorvlikivcjwq4nqmv5qraz5i/HRMSNEARWORLDORDERNEARCONNFT.jpg";
    ...
    pub fn new_default_meta(owner_id: AccountId, receiver_id: AccountId, receiver1_id: AccountId) -> Self {
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Near Hub - NEAR World Order NEAR Con 22 NFTs".to_string(),
