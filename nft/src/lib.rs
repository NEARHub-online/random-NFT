...
const NFT_WHITELIST: &str = "https://nftstorage.link/ipfs/bafybeicg4bhbum27qsue536qzjdurzxy7soz3qzru2qqw2hnws43xo5cgq";
const NFT_IMAGES: [&str; 5] = [
    "https://nftstorage.link/ipfs/bafybeiaitt66fq7mardkkotlw3qramcdyev4fhlxipvmuy6or4sv2lmmnq",
    "https://nftstorage.link/ipfs/bafybeif7w3s4kk6wwcqx3q6xu5sebc7o2yfng6btt2bhdx3mqexple3lna",  
    "https://nftstorage.link/ipfs/bafybeif44wn2mkhwagcq4j2nupslf76lolk3j4ttffjx6hzrr6gwinj5m4", 
    ...
    pub fn new_default_meta(owner_id: AccountId, receiver_id: AccountId, receiver1_id: AccountId, receiver2_id: AccountId) -> Self {
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Near Hub - HRMS NFT Comics".to_string(),
                symbol: "HRMS".to_string(),
    ...
    */
    ...
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata, receiver_id: AccountId, receiver1_id: AccountId, receiver2_id: AccountId) -> Self {
        ...
        let mut this = Self {
            ...
            receiver2_id: receiver2_id.clone().into(),
        };

        this.perpetual_royalties.insert(&this.receiver_id, &400);
        this.perpetual_royalties.insert(&this.receiver1_id, &200);
        this.perpetual_royalties.insert(&this.receiver2_id, &400);
