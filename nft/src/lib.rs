...
const MINT_PRICE_1: u128 = 100_000_000_000_000_000_000_000;
const MINT_PRICE_2: u128 = 1_100_000_000_000_000_000_000_000;
const MINT_PRICE_3: u128 = 2_100_000_000_000_000_000_000_000;
const MINT_PRICE_4: u128 = 5_100_000_000_000_000_000_000_000;
const NFT_IMAGES: &str = "https://cloudflare-ipfs.com/ipfs/bafybeiacf4hizvcw3r3ibiamwqcadcffophxqwfmoqntndtzouq7hlgcge/nftsfXnear.mp4";
...
impl Contract {
    ...
    */
    #[init]
    pub fn new_default_meta(owner_id: AccountId, receiver_id: AccountId, receiver_id1: AccountId) -> Self {
        assert!(
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Haunted house by NEAR Hub & NFT SF".to_string(),
                symbol: "SFNFT".to_string(),
    ...
    */
    #[init]
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata,  receiver_id: AccountId, receiver_id1: AccountId) -> Self {
        ...
        this.perpetual_royalties.insert(&receiver_id, &500);
        this.perpetual_royalties.insert(&receiver_id1, &500);
        this
